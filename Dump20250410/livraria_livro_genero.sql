...
CREATE TABLE `livro_genero` (
  ...
  CONSTRAINT `livro_genero_ibfk_1` FOREIGN KEY (`livro_id`) REFERENCES `livro` (`id`),
  CONSTRAINT `livro_genero_ibfk_2` FOREIGN KEY (`genero_id`) REFERENCES `genero` (`id`)
...
-- Dump completed on 2025-04-10  1:19:42
